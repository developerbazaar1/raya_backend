...
exports.projectDetailService = async (userId, projectId, query = {}) => {
    ...
    }).select("projectName dueDate assignedUsers progress totalTasks completedTasks").populate('assignedUsers', 'name userProfile');
...
exports.updateProjectStatusService = async (userId, projectId, body) => {
    ...
    const taskStatus = taskStats.totalAssigned > 0
