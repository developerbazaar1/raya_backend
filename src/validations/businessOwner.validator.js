...
const updateBusinessOwnerSettingsValidation = [
  ...
  body('businessType').optional().trim().notEmpty().withMessage('businessType cannot be empty'),
  ...
  body('totalTimeOff').optional().isNumeric().withMessage('totalTimeOff must be a number'),
...
const updateBusinessOwnerFoundationValidation = [
  ...
  body('values.*').optional().trim().notEmpty().withMessage('each value must be a non-empty string')
];
